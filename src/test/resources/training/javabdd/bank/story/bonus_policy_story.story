Meta: Bonus Policy
      The bank follows a bonus policy, depending on the customer type and on the credit offers

Narrative:
As a bank
I want to be able to manage the bonus awardings
So that the policies of the bank are followed

Scenario: Usual customer bonus policy
...
Scenario: VIP customer bonus policy
